...
int main() {
    ...
    //,2,3,4,5
    int jeux[] = {1};
    //, 5000, 10000, 20000, 50000, 80000, 120000, 200000
    int nb_cles[] = {1000, 5000, 10000, 20000, 50000};

    FILE *csv_file_tas_arbre = fopen("performance_tas_arbre_AjoutIt.csv", "w");
    if (csv_file_tas_arbre == NULL) {
        perror("Cannot open performance_tas_arbre_AjoutIt.csv");
        return 1;
    }
